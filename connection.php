        ...
        <div class="jumbotron">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    ?>
                    <table id="datatableid" class="table table-bordered table-hover text-center table-dark">
                        <thead>
                            <tr>
                                ...
                                <th colspan="2" width="20%" scope="col" class="rounded-end">Action</th>
                            </tr>
                        </thead>
                        <?php
                if($query_run)
                ...
                <form action="insert.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="qty" min="1" class="form-control" placeholder="Enter Quantity" required>
                        </div>
            ...
            <div class="modal-content">
                ...
                <form action="update.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label> Description </label>
                            <input type="text" name="desc" id="editdesc" class="form-control"
                                >
                        </div>
                    </div>
                    <div class="modal-footer">
